...
let pmain = document.getElementById('text');
let fonts = [ 'Lobster', 'cursive', 'Courier']
// for (let index = 0; index < 50; index++) {
//     pmain.style.fontFamily = fonts[index]
//     if(index == 3){
//         index=0
//     }
...
french.addEventListener('click', (e) => {
    ...
    phone.innerHTML = '<i class="fa fa-phone"> Appel';
...
english.addEventListener('click', (e) => {
    ...
    phone.innerHTML = '<i class="fa fa-phone"> Phone'
